        ...
        try:
            ...
            for paper in papers:
                ...
                for author in paper.authors:
                    ...
                    assert author.normalized_name == author.name.lower().strip(), \
...
class TestStaffValidation:
    ...
    def test_exact_staff_match(self):
        ...
        if staff_validator.staff_names:
            ...
            assert staff_validator.is_staff_member(test_name, fuzzy_threshold=100), \
...
class TestPerformance:
    ...
    def test_keyword_extraction_speed(self):
        ...
        assert avg_time < 0.05, f"Keyword extraction took {avg_time}s, should be < 0.05s"
                ...
                if file.endswith(".py"):
                    ...
                    with open(filepath, 'r') as f:
                        ...
                        for i, line in enumerate(lines[:50]):
                            ...
                            elif import_section_ended and line.startswith(('import', 'from')):
