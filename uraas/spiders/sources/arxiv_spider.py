...
class ArxivSpider(scrapy.Spider):
    ...
    def __init__(self, institution='unilag', target=20, boost_special=True,
        ...
        self.logger.info(f"ROR ID: {self.ror_id}  | boost_special={self.boost_special} | sc_only={self.sc_only}")
    ...
    def _build_url(self, *, extra_term: str = '') -> str:
        ...
        if extra_term:
            ...
            extra = (
                f"&terms-1-operator=AND&terms-1-term={extra_q}&terms-1-field=all"
            )
        return (
