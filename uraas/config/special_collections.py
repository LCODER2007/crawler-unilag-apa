...
mostly return irrelevant noise that the sc_score_of() gate then has to reject one-by-one - correct, but a waste of request budget compared to a same-or-better yield from the
