...
SDG_DEFINITIONS: Dict[int, Dict] = {
    1:  {"name": "No Poverty",              "core": ["poverty", "economic inequality", "social protection", "income", "destitution", "livelihood", "microcredit", "social safety net", "extreme poverty", "basic needs"]},
    2:  {"name": "Zero Hunger",             "core": ["food security", "malnutrition", "hunger", "food systems", "agriculture", "crop production", "famine", "nutrition", "food access", "smallholder farmers"]},
    3:  {"name": "Good Health",             "core": ["health", "disease", "medicine", "clinical", "mortality", "morbidity", "vaccine", "immunization", "malaria", "hiv", "tuberculosis", "cancer", "mental health", "maternal health", "child mortality", "public health", "epidemiology", "infectious disease", "non-communicable disease"]},
    4:  {"name": "Quality Education",       "core": ["education", "learning outcomes", "school", "university", "literacy", "numeracy", "curriculum", "pedagogy", "teacher training", "educational access", "early childhood", "higher education", "vocational training"]},
    5:  {"name": "Gender Equality",         "core": ["gender equality", "women empowerment", "female participation", "gender-based violence", "feminism", "gender gap", "reproductive rights", "sexual harassment", "discrimination against women", "gender mainstreaming"]},
    6:  {"name": "Clean Water",             "core": ["water supply", "sanitation", "wastewater treatment", "drinking water quality", "water scarcity", "water access", "hygiene", "groundwater", "water pollution", "watershed"]},
    7:  {"name": "Affordable Energy",       "core": ["renewable energy", "solar power", "wind energy", "energy access", "photovoltaic", "energy poverty", "electricity grid", "energy efficiency", "hydropower", "biomass energy", "off-grid"]},
    8:  {"name": "Decent Work",             "core": ["employment", "labour market", "economic growth", "entrepreneurship", "gdp growth", "decent work", "youth employment", "informal economy", "productivity", "workers rights", "job creation"]},
    9:  {"name": "Industry and Innovation", "core": ["innovation", "infrastructure", "industrial development", "manufacturing", "technology transfer", "research and development", "patent", "startup", "digitalization", "industrialization"]},
    10: {"name": "Reduced Inequalities",    "core": ["inequality", "income distribution", "social inclusion", "discrimination", "marginalization", "affirmative action", "wealth gap", "racial inequality", "ethnic inequality"]},
    11: {"name": "Sustainable Cities",      "core": ["urban planning", "smart city", "housing", "transport", "urbanization", "slum", "public space", "urban resilience", "waste management", "urban governance"]},
    12: {"name": "Responsible Consumption", "core": ["sustainable consumption", "circular economy", "waste reduction", "recycling", "sustainable production", "resource efficiency", "plastic pollution", "food waste", "lifecycle assessment"]},
    13: {"name": "Climate Action",          "core": ["climate change", "global warming", "carbon emissions", "greenhouse gas", "climate adaptation", "climate mitigation", "sea level rise", "carbon footprint", "climate policy", "net zero"]},
    14: {"name": "Life Below Water",        "core": ["ocean", "marine ecosystem", "fisheries", "coastal management", "aquatic biodiversity", "coral reef", "sea pollution", "overfishing", "marine conservation", "lagoon"]},
    15: {"name": "Life on Land",            "core": ["biodiversity", "ecosystem", "deforestation", "land degradation", "wildlife conservation", "endangered species", "forest management", "land use change", "wetland", "desertification"]},
    16: {"name": "Peace and Justice",       "core": ["governance", "rule of law", "corruption", "institutional capacity", "peace", "conflict", "human rights", "access to justice", "transparency", "democracy", "peacebuilding"]},
    17: {"name": "Partnerships",            "core": ["international cooperation", "development aid", "public-private partnership", "technology transfer", "south-south cooperation", "global governance", "multilateralism", "financing for development"]},
}
...
SPECIAL_COLLECTIONS: Dict[str, List[str]] = {
    ...
    "African Literature": [
        ...
        "african novel", "african drama", "oral literature", "oral poetry",
        "african aesthetics", "indigenous poetry", "pan-africanism",
    ...
    "Cultural Heritage": [
        ...
        "heritage preservation", "oral history", "material culture",
        "museum studies", "cultural memory", "sacred sites", "cultural artifacts",
    ...
    "Postcolonial Studies": [
        ...
        "subaltern", "hybridity", "mimicry", "diaspora studies",
...
STOP_WORDS = {
    ...
    "their", "which", "these", "about", "other", "into", "than", "more", "such",
    "some", "what", "when", "where", "there", "also", "using", "used", "show",
    "both", "each", "only", "very", "well", "high", "low", "new", "large",
    "small", "significant", "different", "similar", "total", "however",
    "therefore", "thus", "hence", "although", "despite", "while", "after",
    "before", "through", "across", "during", "within", "among", "between",
    "either", "neither", "whether", "since", "upon", "against", "without",
    "under", "over", "above", "below", "around", "towards", "onto", "itself",
    "itself", "itself", "they", "them", "their", "those", "these", "here",
    "then", "just", "like", "make", "many", "most", "much", "even", "back",
    "still", "need", "could", "would", "should", "shall", "will", "might",
    "must", "been", "have", "does", "done", "made", "said", "take", "come",
    "find", "give", "know", "look", "seem", "feel", "become", "include",
    "provide", "require", "remain", "suggest", "indicate", "demonstrate",
    "show", "reveal", "confirm", "report", "find", "identify", "examine",
    "determine", "evaluate", "assess", "compare", "describe", "present",
    "discuss", "explore", "investigate", "conduct", "perform", "apply",
    "observe", "measure", "calculate", "estimate", "predict", "test",
    # Academic filler
    "study", "paper", "research", "analysis", "findings", "results",
    "method", "approach", "model", "system", "review", "case", "report",
    "effect", "impact", "based", "data", "conclusion", "objective",
    "background", "introduction", "abstract", "methods", "discussion",
    "purpose", "aim", "goal", "hypothesis", "evidence", "sample", "group",
    "population", "intervention", "outcome", "variable", "factor",
    "relationship", "association", "correlation", "significance",
    "difference", "increase", "decrease", "higher", "lower", "greater",
    "lower", "compared", "respectively", "overall", "showed", "found",
    "reported", "observed", "noted", "significantly", "p-value",
    "confidence", "interval", "mean", "median", "standard", "deviation",
    "percent", "percentage", "proportion", "ratio", "rate", "number",
    "approximately", "moreover", "furthermore", "additionally", "however",
    "nevertheless", "consequently", "therefore", "conclusion", "finally",
    "firstly", "secondly", "lastly", "currently", "recently", "previously",
    "generally", "specifically", "particularly", "mainly", "primarily",
    "mostly", "largely", "significantly", "approximately", "relatively",
    # Metadata / XML / JATS artifacts
    "jats", "jats-inline", "journal", "abstract", "article", "title",
    "italic", "bold", "sup", "sub", "break", "para", "section", "body",
    "front", "back", "meta", "keyword", "keywords", "author", "authors",
    "affiliation", "institution", "corresponding", "mailto", "email",
    "grant", "funding", "acknowledgment", "acknowledgements", "references",
    "bibliography", "footnote", "table", "figure", "appendix", "supplement",
    # Geographic terms too broad to be meaningful keywords
    "nigeria", "nigerian", "lagos", "africa", "african", "world", "global",
    "international", "national", "regional", "local", "country", "countries",
    "continent", "west", "east", "south", "north", "central",
    # Numbers and fragments that slip through
    "2266", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022",
    "2023", "2024", "2025",
    # Short meaningless words (caught by length filter but listed for clarity)
    "also", "into", "onto", "upon", "with", "from", "have", "that",
}
...
def classify_special_collections(title: str, abstract: str, dc_subject: str = '') -> List[Dict]:
    """
...
def extract_keywords(title: str, abstract: str, top_n: int = 60,
                     all_texts: Optional[List[str]] = None) -> List[Dict]:
    """
    ...
    for term, freq in term_freq.items():
        ...
        scored.append({'word': term, 'score': score, 'count': freq, 'type': 'phrase' if ' ' in term else 'term'})
    ...
    if _spacy_available and nlp:
        try:
            ...
            for ent in doc.ents:
                ...
                if ent.label_ in ('ORG', 'PRODUCT', 'WORK_OF_ART', 'EVENT', 'LAW', 'NORP'):
                    ent_text = ent.text.lower()
                    ent_clean = _clean_text(ent_text)
                    if len(ent_clean) >= 4 and _is_valid_word(ent_clean.split()[0]):
                        scored.append({'word': ent_clean, 'score': 6.0, 'count': 1, 'type': 'entity'})
        except Exception:
            pass
        ...
        for term, score in top_terms:
            ...
            if overlap >= 1:
                ...
                co_occur = sum(
                    ...
                    if seed_term in t.lower() and term in t.lower()
                )
                if co_occur >= 1:
                    related.append(term)
                    used_terms.add(term)
