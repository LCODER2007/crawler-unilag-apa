...
capitals = {
    "Egypt": "Cairo", "Morocco": "Rabat", "Algeria": "Algiers", "Tunisia": "Tunis", "Libya": "Tripoli", "Sudan": "Khartoum",
    "Nigeria": "Abuja", "Ghana": "Accra", "Senegal": "Dakar", "Cote d'Ivoire": "Yamoussoukro", "Benin": "Porto-Novo", "Burkina Faso": "Ouagadougou", "Cape Verde": "Praia", "Gambia": "Banjul", "Guinea": "Conakry", "Guinea-Bissau": "Bissau", "Liberia": "Monrovia", "Mali": "Bamako", "Mauritania": "Nouakchott", "Niger": "Niamey", "Sierra Leone": "Freetown", "Togo": "Lome",
    "Kenya": "Nairobi", "Uganda": "Kampala", "Tanzania": "Dodoma", "Ethiopia": "Addis Ababa", "Rwanda": "Kigali", "Burundi": "Gitega", "Djibouti": "Djibouti", "Eritrea": "Asmara", "Somalia": "Mogadishu", "South Sudan": "Juba", "Madagascar": "Antananarivo", "Mauritius": "Port Louis", "Seychelles": "Victoria", "Comoros": "Moroni",
    "South Africa": "Pretoria", "Zimbabwe": "Harare", "Zambia": "Lusaka", "Namibia": "Windhoek", "Botswana": "Gaborone", "Lesotho": "Maseru", "Eswatini": "Mbabane", "Malawi": "Lilongwe", "Mozambique": "Maputo",
    "Cameroon": "Yaounde", "DR Congo": "Kinshasa", "Angola": "Luanda", "Gabon": "Libreville", "Republic of the Congo": "Brazzaville", "Central African Republic": "Bangui", "Chad": "N'Djamena", "Equatorial Guinea": "Malabo", "Sao Tome and Principe": "Sao Tome"
}
...
for subregion, countries in subregions.items():
    ...
    for country in countries:
        ...
        templates = [
            ...
            f"Ahmadu Bello University of {cap}" if country == "Nigeria" else f"Federal University of {cap}",
...
print("Generated data/university_registry.json with 52 countries and 18 universities each.")

# Configurations for the 15 new universities to make a total of 25 demo universities
new_universities = [
    # North (5)
    {"file": "cairo.json", "ror": "https://ror.org/03c4mpy73", "name": "Cairo University", "short_name": "Cairo Univ", "country": "Egypt", "sub_region": "North Africa"},
    {"file": "ainshams.json", "ror": "https://ror.org/034x7p097", "name": "Ain Shams University", "short_name": "Ain Shams", "country": "Egypt", "sub_region": "North Africa"},
    {"file": "alexandria.json", "ror": "https://ror.org/02078r490", "name": "Alexandria University", "short_name": "Alexandria", "country": "Egypt", "sub_region": "North Africa"},
    {"file": "tunis.json", "ror": "https://ror.org/050j3a172", "name": "Université de Tunis El Manar", "short_name": "Tunis El Manar", "country": "Tunisia", "sub_region": "North Africa"},
    {"file": "mohammedv.json", "ror": "https://ror.org/03vpy3v17", "name": "Université Mohammed V de Rabat", "short_name": "Mohammed V", "country": "Morocco", "sub_region": "North Africa"},
    
    # Central (5)
    {"file": "yaoundei.json", "ror": "https://ror.org/04h7g6177", "name": "Université de Yaoundé I", "short_name": "Yaoundé I", "country": "Cameroon", "sub_region": "Central Africa"},
    {"file": "kinshasa.json", "ror": "https://ror.org/05vzwad88", "name": "Université de Kinshasa", "short_name": "UNIKIN", "country": "DR Congo", "sub_region": "Central Africa"},
    {"file": "agostinhoneto.json", "ror": "https://ror.org/00z2bpt98", "name": "Université Agostinho Neto", "short_name": "Agostinho Neto", "country": "Angola", "sub_region": "Central Africa"},
    {"file": "marienngouabi.json", "ror": "https://ror.org/02y1sra05", "name": "Université Marien Ngouabi", "short_name": "Marien Ngouabi", "country": "Republic of the Congo", "sub_region": "Central Africa"},
    {"file": "masuku.json", "ror": "https://ror.org/059gqse72", "name": "Université des Sciences et Techniques de Masuku", "short_name": "USTM Masuku", "country": "Gabon", "sub_region": "Central Africa"},
    
    # Southern (+3 new ones)
    {"file": "wits.json", "ror": "https://ror.org/039482g93", "name": "University of the Witwatersrand", "short_name": "Wits", "country": "South Africa", "sub_region": "Southern Africa"},
    {"file": "pretoria.json", "ror": "https://ror.org/047fpp722", "name": "University of Pretoria", "short_name": "UP", "country": "South Africa", "sub_region": "Southern Africa"},
    {"file": "zimbabwe.json", "ror": "https://ror.org/03w489125", "name": "University of Zimbabwe", "short_name": "UZ", "country": "Zimbabwe", "sub_region": "Southern Africa"},
    
    # East (+2 new ones)
    {"file": "daressalaam.json", "ror": "https://ror.org/0199e1957", "name": "University of Dar es Salaam", "short_name": "UDSM", "country": "Tanzania", "sub_region": "East Africa"},
    {"file": "rwanda.json", "ror": "https://ror.org/02yr01r27", "name": "University of Rwanda", "short_name": "UR", "country": "Rwanda", "sub_region": "East Africa"}
]
